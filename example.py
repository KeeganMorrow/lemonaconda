...
panel.add_segment(statusbar.BspwmDesktops(properties={'bgcolor':'00afff', 'pl_left':False, 'pl_right': True, 'alignment':'left', 'fgcolor_active': 'ffffff', 'fgcolor_inactive': '181818', 'fgcolor_urgent': 'ff0000'}))
